...
// Falls back to debug signing when the file isn't present.
...
android {
    namespace = "com.chusftwr.srctv_flutter"
    ...
    defaultConfig {
        ...
        applicationId = "com.chusftwr.srctv_flutter"
    ...
    buildTypes {
        release {
            // Sign with the release keystore (android/key.properties) when present,
